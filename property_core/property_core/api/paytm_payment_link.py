...
@frappe.whitelist()
def generate_ecommerce_payment_link(so_name):
    ...
    frappe.cache().set_value(
        ...
        {"flow": "ecommerce", "so_name": so_name, "customer": customer, "amount": amount},
    ...
    return {"link": link_url, "amount": amount, "order_id": order_id, "message": message}
